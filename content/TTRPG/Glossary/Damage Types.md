...
**Falling damage:** is 1d6 per meter fell, cannot be reduced only by a relevant feature or passive. A creature falls (in the current turn) at a rate of 150 meters per turn.

***Vulnerability & Resistance*** 
_Res: Acid 3_ From the acid damage taken we subtract the Res amount.
_Vul: Cold 3_ it adds extra 3 damage to the cold damage taken.
...
- **Bleeding:** This damage type only affects creatures that don't have Armor, made of flesh and are alive or can bleed. This damage bypasses natural armor and _Physical_ _Resistance_.  ^823df2
- **Poison:** Venomous stings and toxic gas deals poison damage. Some poisons apply the *[[Conditions#Poisoned|Poisoned]]* condition if the creature fails a _Fortitude Saving Throw_ against the poison’s DC.

### Mental

- **Psychic:** Mental Abilities such as a koshmera’s screech deals psychic damage.
