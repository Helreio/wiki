...
password:
---
In a round on your turn you have 3 Action Points and one Reaction.
...
- **An Attack** is blocked as a _Reaction_ and the damage is reduced by the _Block_ value (specified in the properties of the shield).
...
- **Resolve the Attack.** You make the Attack roll. On a roll equal or higher than the ***Evasion Class (EC)*** the attack hits but it is reduced by their ***Armor (Ar).*** If the attack roll is a nat 20 it deals full damage bypassing any Armor.
- **Determining Damage.** You roll the damage dice and then you subtract the ***Armor (Ar)*** if applicable, then the GM subtracts the damage dealt from the _hit points_ of the creature.

**Ranged Attacks in Close Combat**
Aiming a ranged Attack is more difficult when a foe is next to you. When you make a ranged Attack with a weapon, a spell, or some other means, you have *Disadvantage* on the Attack roll if you are within 1 meter of a Hostile creature who can see you and who isn’t *[[Conditions#Incapacitated|Incapacitated]].*
...
**Grapple Check:** _Strength (Athletics) check_ contested by the target’s *Strength (Athletics)* or *Agility (Acrobatics) check* (the target chooses the ability to use). If you succeed, you subject the target to the *[[Conditions#Grappled|Grappled]]* condition (see Conditions). The condition specifies the things that end it, and you can release the target whenever you like (no Action required).
With a second _Grappling Action_ you may attempt to *[[Conditions#Restrain|Restrain]]* the target if it fails the contested check again.

**Escaping a Grapple/Restrain:** A Grappled creature can use one Action Point to attempt to Escape. To do so, it must succeed on a _Strength (Athletics)_ or _Agility (Acrobatics) check_ contested by your _Strength (Athletics) check._ If the _Restraint_ is by an object the DM will decide the course of action that needs to be taken to escape.
...
**Sustaining a spell:** On each of your turns you need to spend one _Action Point_ to keep the spell effect active. You can be denied by *[[Dispel Magic]] spell*, *[[Deny the Witch|Deny the Witch]] incantation* or *[[Supernal Censure]] smite* to break the spell. 

**Group Casting:** If you lack the necessary resources to cast a spell, an ally who is specialized in the same school of magic can transfer by touch to you with a _Reaction_ the necessary magic to complete or empower (if specified within the spell) the casting.
During a ***ritual casting*** all participants need to sustain the spell cast as specified within the description of the ritual.

**Sustain a Spell (1 action point per round)** ^845704
Extend a spell or item effect (if specified) until your next turn.
**Cease Sustaining an Active Spell or Effect** is _a_ free action. 

**Activate Magic Item (1 action point)**
Many magic items need to be activated, especially potions, wands, rods, and staffs. Activating a magic item is an _Action Point_ (unless the item description indicates otherwise).
...
**Dropping to Prone** position in your space is a free action.

**Speaking** is a free action that you can perform even when it isn’t your turn. Speaking more than a few words (3-4) is generally beyond the limit of a free action.

**Drawing or Sheathing a Weapon** so that you can use it in combat, or stowing it so that you have a free hand. This action also applies to weapon-like objects carried in easy reach, such as swords and potions. If your weapon or weapon-like object is stored in a pack or otherwise out of easy reach, it requires an _Action Point_ to retrieve a stored item.

**Drawing ammunition** for use with a ranged weapon (such as arrows and bolts from a quiver) is a free action.

**Dropping a carried (but not worn) shield** is a free action. Strapping a shield to your arm to gain its bonuses, or unstrapping and dropping a shield so you can use your shield hand for another purpose, requires an _Action Point_.